...
Lors de notre scan nmap, nous avons vu que le port WinRM est ouvert, (HTTP : 5985 // HTTPS : 5986) nous pouyvons donc nous connecter à distance avec [Evil-WinRM](https://github.com/Hackplayers/evil-winrm) :
